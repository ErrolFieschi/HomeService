                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <form role="form" method="post" action="../Form/insert_service.php"
                                                  onsubmit="return checkForm(this)">
                                            <tbody>
                                                <tr>

                                                    <td>
                                                        <?php echo $form->input('Nouveau Service', 'name', 'text', 'form-control', '', ''); ?>
                                                    </td>

                                                    <td>
                                                        <?php echo $form->textArea('description', 'form-control', 'exampleFormControlTextarea1', '1'); ?>
                                                    </td>

                                                    <td>
                                                        <?php echo $form->input('Prix', 'price', 'text', 'form-control', '', ''); ?>
                                                    </td>
