    ...
    <div class="main-panel">
        ...
        <div class="content">
            <div class="container-fluid">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                        <tr>
                                            <td><?php echo $resultat['id']; $tmpIdAssign = $resultat['id']; ?></td>

                                            <td><?php $reqServ = cmpAccount($resultat['fk_account']); ?></td>

                                            <td><?php $reqServ = cmpServ($resultat['fk_service']); ?></td>

                                            <td><?php echo date("d/m/Y " ,strtotime($resultat['s_date'])) . " " .  $resultat['start_time']; ?></td>

                                            <td><?php echo date("d/m/Y " ,strtotime($resultat['end_date'])) . " " .  $resultat['end_time']; ?></td>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <?php
                                        $s = selectPro($resultat['s_date'], $resultat['end_date'], $resultat['fk_service']);}
                                        while ($res = $s->fetch(PDO::FETCH_ASSOC)) {
                                            $f = selectProJob($res['fk_provider'], $res['fk_service']);
                                            while($findPro = $f->fetch(PDO::FETCH_ASSOC)){$info += 1;
                                                ?>
                                                <tbody>
                                                <tr>
                                                    ...
                                                    <td> <a href="../Form/update_prestation.php?id=<?=$findPro['id']?>&pro=<?=$tmpIdAssign ?>"><?php echo $findPro['lastname'];?></a></td>
                ...
                <?php if($info == 0){ ?>
                    <div class="alert alert-warning" role="alert">Information ! Aucun prestataire disponible disponible pour le moment. </div>
                <?php }?>
            </div>
        </div>
        <footer class="footer">
