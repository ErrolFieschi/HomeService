                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        while ($resultat = $req->fetch(PDO::FETCH_ASSOC)) { ?>
                                            ...
                                            <form role="form" method="post" action="/../FloconHome/Form/update_prestation.php?id=<?= $resultat['id'] ?>"">
                                            <tbody>
                                            <tr>
                                                ...
                                                <td><?php echo $resultat['start_date']; ?></td>

                                                <td><?php  echo convertTime($resultat['start_time']); ?></td>

                                                <td><?php  echo convertTime($resultat['end_time']); ?></td>

                                                <td class="text-primary"><?php echo $resultat['description']; ?> </td>
