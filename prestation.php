...
?>
    ...
    <head>
        ...
        <meta name="description"
              content="Flocon a été développé pour optimiser l'organisation de vos repas au quotidien. Indiquez vos
              préférences culinaires et il s'occupera du reste !">
    ...
    <main>
        <section class="section section-shaped section-lg">
            <div class="<?php if($connected) echo 'shape section-connected';
            else echo 'shape shape-style-1 shape-default';?>">
                            ...
                            <div class="card-header bg-white pb-5">
                                <div class="card-body px-lg-5 py-lg-5">
                                    <div class="text-center text-muted mb-4">
                                        <small><?php echo _("Insérez les informations concernant vos besoins"); ?></small>
                                    </div>

                                    <form role="form" method="post" action="funnel/paymentPresta.php">
                                        <div class="form-group">
                                            <?php echo $form->select('Service', 'service', $options, "form-control", '', ''); ?>
                                        </div>

                                        <div class="form-group">
                                            <label><?php echo _("Date de début : "); ?></label>
                                            <div class="input-group input-group-alternative mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text"><i class="fas fa-calendar-week"></i></span>
                                                </div>
                                                <?php echo $form->input(_("jj/mm/aaaa"), 'Sdate', 'date', 'form-control', '', 'date'); ?>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label><?php echo _("Date de fin : "); ?></label>
                                        <div class="input-group input-group-alternative mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i class="fas fa-calendar-week"></i></span>
                                            </div>
                                            <?php echo $form->input(_("jj/mm/aaaa"), 'Edate', 'date', 'form-control', '', 'date'); ?>
                                        </div>
                                    </div>

                                        <div class="form-group">
                                            <label><?php echo _("Heure de début : "); ?></label>
                                            <div class="input-group input-group-alternative mb-3">
                                        ...
                                        <div class="form-group">
                                            <label><?php echo _("Heure  de fin : "); ?></label>
                                            <div class="input-group input-group-alternative mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text"><i class="fas fa-clock"></i></span>
