...
$pagesTotal = reqPaginationWaitingLine($MAX);
?>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <?php
                                        $infos = reqInfosWaitingLine($MAX,$pagesCourante);
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination justify-content-center">
                        ...
                        for ($i = 1; $i <= $pagesTotal ; $i++) {
                            echo ' <li class="page-item"><a class="page-link" href="waiting_line.php?page=' . $i.'">' . $i . '</a></li>';
                        }
                        ?>
